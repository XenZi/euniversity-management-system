...
func main() {
	...
	router.HandleFunc("/applications/pin/{pin}", applicationsHandler.FindAllApplicationsByUserPIN).Methods("GET")
	router.HandleFunc("/applications/single/{id}", applicationsHandler.FindApplicationByID).Methods("GET")
	router.HandleFunc("/applications/admission/{id}", applicationsHandler.FindAllApplicationsForOneAdmission).Methods("GET")
	router.HandleFunc("/applications/admission/review/{id}", applicationsHandler.FindAllUnderReviewApplicationsForSpecifiedAdmission).Methods("GET")
	router.HandleFunc("/applications/admission/accepted/{id}", applicationsHandler.FindAllAcceptedApplicationsForSpecifiedAdmission).Methods("GET")
	router.HandleFunc("/applications/{id}", applicationsHandler.UpdateApplication).Methods("PUT")
	router.HandleFunc("/applications/{id}", applicationsHandler.DeleteApplicationByID).Methods("DELETE")
	// CORS
