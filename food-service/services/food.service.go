...
func (fs FoodService) UpdateMessRoomSupplier(messId,supplierId string) (*models.MessRoom, *errors.ErrorStruct) {
	mess, err := fs.FoodRepository.UpdateMessRoomsSupplier(messId,supplierId)
	if err != nil {
		return nil, err
	}
	return mess, nil
...
func (fs FoodService) UpdateMessRoomUsers(messId,studentPin string) (*models.MessRoom, *errors.ErrorStruct) {
	mess, err := fs.FoodRepository.UpdateMessRoomUsers(messId,studentPin)
	if err != nil {
		return nil, err
	}
	return mess, nil
